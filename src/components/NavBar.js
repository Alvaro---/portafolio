...
const NavBar = () => {
    ...
    return (
        <Navbar className="color-nav" expand="md" variant="dark"> {/* className="color-nav" O bg="dark" */}
            <Container>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="ms-auto">
                        ...
                        <Nav.Link href="#features"><FormattedMessage id="about" defaultMessage="About" /></Nav.Link>
                        ...
                        <Nav.Link href="#contacts"><FormattedMessage id="contacts" defaultMessage="Contact" /></Nav.Link>
